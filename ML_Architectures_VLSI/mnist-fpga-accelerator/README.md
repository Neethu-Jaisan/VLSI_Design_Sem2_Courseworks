...
##🎯 Objective##
To design a simple neural network inference accelerator for handwritten character recognition
To understand how ML algorithms are mapped to hardware
To explore dataflow-oriented architectures suitable for FPGA implementation
To demonstrate the concept of hardware acceleration for ML workloads
